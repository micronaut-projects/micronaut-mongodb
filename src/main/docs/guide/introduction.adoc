...
Note that this project provides only low-level access to the MongoDB client drivers (synchronous, reactive streams, and Kotlin coroutine). If you are looking for a more complete experience including support for data access repositories see the documentation for https://micronaut-projects.github.io/micronaut-data/latest/guide/#mongo[Micronaut Data MongoDB] as well as these useful guides:
