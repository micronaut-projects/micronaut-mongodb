...
dependency:micronaut-mongo-coroutine[groupId="io.micronaut.mongodb"]

Then the https://mongodb.github.io/mongo-java-driver/5.6/apidocs/driver-kotlin-coroutine/com/mongodb/kotlin/client/coroutine/MongoClient.html[Kotlin coroutine `MongoClient`] will be available for injection.
