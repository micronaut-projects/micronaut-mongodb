...
/**
 * Factory for the default {@link MongoClient}.
 *
 * @author graemerocher
 * @since 6.0.0
 */
...
public class DefaultCoroutineMongoClientFactory {
    ...
    static final MongoDriverInformation DRIVER_INFORMATION = MongoDriverInformation.builder()
        .driverName("kotlin")
     ...
     */
    public DefaultCoroutineMongoClientFactory(MongoClientCloser mongoClientCloser) {
        this.mongoClientCloser = mongoClientCloser;
    }

    /**
     * Factory method to return the default client.
     *
     * @param configuration The default Mongo configuration
